...
class AutoDemo(object):
  def __init__(self, name='default_auto_tutorial', reading_speed=2):
    ...
    OV.registerFunction(self.run_autodemo,False,'demo')
    OV.registerFunction(self.run_demo_loop,False,'demo')
    OV.registerFunction(self.next_demo_item,False,'demo')
    OV.registerFunction(self.back_demo_item,False,'demo')
    OV.registerFunction(self.cancel_demo_item,False,'demo')
    OV.registerFunction(self.switch_tab_for_tutorials,False,'demo')
